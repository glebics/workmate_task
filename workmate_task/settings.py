"""
Django settings for workmate_task project.
...
ROOT_URLCONF = 'workmate_task.urls'
...
WSGI_APPLICATION = 'workmate_task.wsgi.application'


# Database
# https://docs.djangoproject.com/en/4.1/ref/settings/#databases

# будем использовать postgres, а не sqlite3
DATABASES = {
    'default': {
